...
def get_fidelity_jobs(roles, days=7):
    ...
    def fetch_role_jobs(target_role):
        ...
        base_url = "https://wd1.myworkdaysite.com/wday/cxs/fmr/FidelityCareers/jobs"
        payload = {
    ...
    def process_fidelity_job(job, cutoff_date):
        ...
        try:
            job_url = f"https://wd1.myworkdaysite.com/en-US/recruiting/fmr/FidelityCareers{job.get('externalPath', '')}"
...
def format_fidelity_job_data(job, metadata):
    return {
        ...
        "job_url": f"https://wd1.myworkdaysite.com/en-US/recruiting/fmr/FidelityCareers{job.get('externalPath', '')}",
        "date_posted": format_fidelity_date(metadata['datePosted']),
...
#     jobs_data = get_fidelity_jobs(roles=fidelity_roles, days=7)
